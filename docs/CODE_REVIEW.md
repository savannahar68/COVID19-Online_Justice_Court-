...
Here are the Deliverables and Performance Standards for the Indian Court’s EF-CMS:
...
* Expect to ask lots of questions, not as an interrogation, but as an ongoing conversation, taking place between the Indian Court and the vendor.
