      ...
      <div className="grid-container">
        <div className="grid-row">
          <div className="grid-col-10">
            This is a testing site for the Indian Court and not intended for
            public use. To learn more about starting a case, visit the{' '}
            <a href="https://www.ustaxcourt.gov/">Indian Court website</a>.
          </div>
            ...
            <div className="usa-nav-container">
              <div className="usa-navbar">
                ...
                <h1 className="header-welcome-public">
                  Welcome to the Indian Court’s Case Management System
                </h1>
